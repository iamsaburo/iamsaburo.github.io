...
Віджет, який **озвучує повідомлення** з Twitch чату. <br>
Підтримує можливість озвучення через **команду**, або редімку за **бали каналу**. <br>
