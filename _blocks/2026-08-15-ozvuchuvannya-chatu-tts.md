...
Віджет, який **озвучує повідомлення** з `Twitch` / `YouTube` чату. <br>
Все працює через **StreamElements** - додаєш як браузер джерело і готово, **нічого більше встановлювати не треба**. <br>
...
## КОМАНДИ
`!ttsstop` - **зупинити** озвучку повідомлення <br>
`!ttsoff` - **вимкнути** озвучку через команду <br>
`!ttson` - **увімкнути** озвучку через команду <br>
