...
(function(){
  const twitchUsers = [
    ...
    "Kavalets", "gamebulochka", "Otolich", "ArdenLich", "vasilovich_tsv", "SivoLur", "holibimba", "Nazar_Khantil", "pro100rick", "chervnevyy", "makar__2", "Tsookesha", "tetiana_andriivna", "lebudka", "Skylynn_MURR", "panTarann"
  ];
