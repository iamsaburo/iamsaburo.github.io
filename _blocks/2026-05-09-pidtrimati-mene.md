...
<img src="https://raw.githubusercontent.com/iamsaburo/iamsaburo.github.io/refs/heads/main/webp/twitch-banner.webp"
     ...
     style="max-width:100%; border-radius:4px; display:block; margin-top:0.5rem; border: 1px solid rgba(255, 255, 255, 0.05);">
...
(function(){
  const twitchUsers = [
    ...
    "Kavalets", "gamebulochka", "Otolich", "ArdenLich", "vasilovich_tsv", "SivoLur", "holibimba", "Nazar_Khantil", "pro100rick", "chervnevyy", "makar__2", "Tsookesha", "tetiana_andriivna", "lebudka", "blue_lynx_98", "panTarann", "Enot_poloskun7", "KRMx_x", "pumpkinn_8"
  ];
