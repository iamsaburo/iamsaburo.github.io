...
> 💾 Збереження прогресу між стрімами <br>
> 👁️ Авто-пауза перед/після стріму <br>
> 🎨 5 корпусів (Автор: <a href="https://twitch.tv/DannyelGray" target="_blank">DannyelGray</a>) <br>
> 🧬 Еволюції - від яйця до старця <br>
> ❗️ Чат-команди для догляду <br>
> 🎵 Звуки для всіх подій <br>
> 🥇 Таблиця рекордів <br>

## КОМАНДИ
`!старт [ім'я]` - розпочати гру <br>
`!пауза` - призупинити гру <br>
`!рекорди` - хто прожив найдовше <br>
`!ресет` - ресетить гру (стрімер/модер) <br>

Команди потреб: `!вода`, `!їжа`, `!душ`, <br>
`!сон`, `!ліки`, `!прибрати` <br>