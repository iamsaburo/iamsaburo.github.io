...
‎ 
## ОСНОВНІ ФУНКЦІЇ 
> 🌈 Віджет **набуває кольору аватарів**
> 🔗 **Посилання** на сторінку Twitch
> ↔️ **Ширина** підлаштовується під нік
> ❗ **Вибір команди** і альтернатив
> 🛡️ **Дозвіл** на команду: стрімер, модер
> 🔊 **Звукові ефекти** подій
> ⏲️ **Налаштування тривалості**
> 🚀 **Анімації** появи і зникнення
> 🧪 Кнопка **тестового** ShoutOut
> 🔢 **Черга** для кількох команд
